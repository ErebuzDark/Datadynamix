      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-foreground">Datadynamix Technologies LLC</h1>
              <p className="text-xs text-muted-foreground">B2B Cloud Software and Systems</p>
            </div>
          </div>
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            <PrimaryButton icon={<ArrowRightOutlined />}>Request Demo</PrimaryButton>
          </nav>

          {/* Mobile Menu Button */}
          <div className="lg:hidden">
            <Button type="text" icon={<MenuOutlined className="text-xl" />} onClick={() => setDrawerOpen(true)} />
          </div>
        </div>
      </div>
